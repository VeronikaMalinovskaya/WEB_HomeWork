...
$email = 'veronika_malinov@mail.ru'; 

$phone = 375296605156; 

$skills=[
    ['name' => 'спать 24/7', 'percent' => 95],
    ['name' => 'пугать', 'percent' => 80],
    ['name' => 'кусать', 'percent' => 70],
    ['name' => 'царапать', 'percent' => 60],
];
...
'description' => 'Люблю вредничать,спать и вкусно есть',
],
[
'name' => 'Дворовый кот',
'dateStart' => 'май 2021',
'dateEnd' => 'Июль 2022',
'description' => 'Ловил мышей в парке. Отбивался от собак и крыс. Приютила одна мадам и оставила у себя)',
],
[
'name' => 'Кот во младенчестве',
'dateStart' => 'Январь 2021',
'dateEnd' => 'Май 2021',
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          <h2 class="w3-text-grey w3-padding-16"><i
              class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Опыт есть-жизненный!</h2>
        ...
        <div class="w3-container w3-card w3-white">
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b>London Kat School</b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>2021 - 2022</h6>
            <p>Master Degree</p>
            <hr>
          </div>
          <div class="w3-container">
            <h5 class="w3-opacity"><b>School of Dvor</b></h5>
